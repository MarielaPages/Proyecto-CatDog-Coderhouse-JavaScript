...
let productos = [
    {id: 1, nombre: "Contemporary cat tree", precio: 255, imagen: "../media/fotos/contemporary-cat-tree.jpg"},
    {id: 2, nombre: "One floor cat tree", precio: 100, imagen: "../media/fotos/1floor-cat-tree.webp"},
    {id: 3, nombre:"Lotus cat tree", precio: 150, imagen:"../media/fotos/Lotus-cat-tree.jpg"},
    {id: 4, nombre:"Blue wool cat sweater", precio: 80, imagen:"../media/fotos/blue-wool-cat-sweater.jpg"},
    {id: 5, nombre:"White furry bed", precio: 90, imagen:"../media/fotos/white-furry-bed.jpg"},
    {id: 6, nombre:"Igloo brown cat bed", precio: 100, imagen:"../media/fotos/Igloo-cat-bed.jpg"}
]
...
nuevosIngresos.push(new NuevosProductos(7, "Bird cat toy", 40, "../media/fotos/birdCatToy.jpg"));
nuevosIngresos.push(new NuevosProductos(8, "Cat pyjama", 50, "../media/fotos/catPyjamas.jpg"));
nuevosIngresos.push(new NuevosProductos(9, "Four floor cat tree", 120, "../media/fotos/FourFloorCatTree.webp"));

let moreCatProducts = document.getElementById("moreCatProducts");
moreCatProducts.addEventListener("click", agregarProdutos);
function agregarProdutos(){
    ...
    nuevosIngresos.forEach((producto, index) => {
        ...
        contenedor.appendChild(card)
        moreCatProducts.setAttribute("style", "display:None;");
    })
}
...
if (localStorage.getItem("carrito actualizado cats")){
    cart = JSON.parse(localStorage.getItem("carrito actualizado cats"))
    actualizarCarrito();
}
...
function actualizarCarrito(){
    ...
    localStorage.setItem("carrito actualizado cats", JSON.stringify(cart));
}
